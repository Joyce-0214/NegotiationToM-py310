...
from onmt.io.torchtext_compat import Dataset as TorchtextDataset, Example
...
class ONMTDatasetBase(TorchtextDataset):
    """
    ...
    Internally it initializes a Dataset object with
    the following attributes:

     `examples`: a sequence of Example objects.
     `fields`: a dictionary associating str keys with Field
    ...
    def _construct_example_fromlist(self, data, fields):
        ...
        Args:
            ...
            fields: a dict of Field objects. The keys
